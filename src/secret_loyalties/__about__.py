"""
This module contains meta-data for the secret_loyalties project.
"""

# meta data
__project__ = "secret_loyalties"
__description__ = "Code and docs for Secret Loyalties hackathon"
...
__copyright__ = f"Copyright (c) 2025 {__author_string__}"
